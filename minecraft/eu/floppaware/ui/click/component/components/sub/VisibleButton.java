...
public class VisibleButton extends Component {
	...
	public VisibleButton(Button button, Feature mod, int offset) {
		this.parent = button;
		this.mod = mod;
	...
	public void renderComponent() {
		...
		Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Visible: " + !mod.hidden, (parent.parent.getX() + 7) * 2, (parent.parent.getY() + offset + 2) * 2 + 5, -1);
		GL11.glPopMatrix();
	}
